/* tkTheme.h,v 1.141 2010/11/29 18:29:04 jenglish Exp
...
MODULE_SCOPE void Ttk_LayoutSize(
    Ttk_Layout,Ttk_State,int *widthPtr,int *heightPtr);
...
MODULE_SCOPE void Ttk_RegisterNamedColor(
    Ttk_ResourceCache, const char *, XColor *);
...
extern void TtkArrowSize(int h, ArrowDirection, int *widthPtr, int *heightPtr);
extern void TtkDrawArrow(Display *, Drawable, GC, Ttk_Box, ArrowDirection);
extern void TtkFillArrow(Display *, Drawable, GC, Ttk_Box, ArrowDirection);
