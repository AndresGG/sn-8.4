/*
 * ttkDecls.h,v 1.11 2009/11/01 17:30:04 jenglish Exp
 *
...
#define TILE_COMPAT_VERSION "0.8"
...
#define Ttk_InitStubs(interp) TtkInitializeStubs( \
	interp, TILE_COMPAT_VERSION, TTK_STUBS_EPOCH, TTK_STUBS_REVISION)
#else

#define Ttk_InitStubs(interp) Tcl_PkgRequire(interp,"tile",TILE_COMPAT_VERSION)
